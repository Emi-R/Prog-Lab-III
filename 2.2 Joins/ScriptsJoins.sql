...
-- Listar apellidos y nombres de aquellos clientes que hayan realizado algún pedido cuya cantidad sea exactamente igual 
-- a la cantidad considerada mayorista del producto.
...
-- Listar por cada producto el nombre del producto, el nombre de la categoría, el precio de venta minorista, el precio de venta mayorista y el porcentaje de 
-- ahorro que se obtiene por la compra mayorista a valor mayorista en relación al valor minorista.

Select 
    P.Descripcion,
    C.Nombre,
    P.Precio,
    P.PrecioVentaMayorista, (P.Precio - P.PrecioVentaMayorista) * 100 / P.Precio as 'Porcentaje de Ahorro'
From Productos P
